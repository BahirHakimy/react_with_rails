...
**React With Rails** A small web app create with Ruby on Rails and React js which shows a radom greeting message.
...
```bash
git clone https://github.com/BahirHakimy/react_with_rails.git
```
